...
export default function Home() {
  ...
  const technologyArticles = [
    ...
    },
    {
      ...
      summary: "New advancements in AI technology are making virtual assistants more conversational and intuitive than ever before.",
    ...
    },
    {
      ...
      summary: "Scientists have achieved a significant milestone in quantum computing that may transform how we approach encryption.",
  ...
  const healthArticles = [
    ...
    },
    {
      ...
      summary: "New research suggests that intermittent fasting may have significant benefits for extending lifespan and improving health.",
    ...
    },
    {
      ...
      summary: "A new survey shows that younger generations are increasingly prioritizing mental health and seeking support when needed.",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        {/* Hero Section */}
        <HeroSection mainArticle={heroData.mainArticle} secondaryArticles={heroData.secondaryArticles} />
