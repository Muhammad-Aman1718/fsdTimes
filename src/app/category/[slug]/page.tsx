...
const getCategoryData = (slug: string) => {
  ...
  const categories: Record<string, { title: string, description: string }> = {
    'technology': {
      title: 'Technology',
      description: 'Latest news and updates from the world of technology, gadgets, and digital innovation.'
    },
    'business': {
      title: 'Business',
      description: 'Business news, market trends, economic updates, and corporate developments.'
    },
    'health': {
      title: 'Health',
    ...
    'climate': {
      title: 'Climate',
      description: 'Climate change news, environmental updates, and sustainability initiatives.'
    },
    'trending': {
      title: 'Trending',
      description: 'Most popular and trending stories from across all categories.'
    }
  };
  
  return categories[slug] || { title: 'Category', description: 'Latest news and updates.' };
};
  ...
  const articles = [
    {
      ...
      summary: "The EU has introduced sweeping new regulations aimed at curbing the power of major technology companies.",
    ...
    },
    {
      ...
      summary: "Researchers have developed a new treatment that shows significant promise in slowing the progression of Alzheimer's disease.",
    ...
    },
    {
      ...
      summary: "The housing market is showing signs of cooling as mortgage rates reach their highest levels in over a decade.",
    ...
    },
    {
      ...
      summary: "World leaders are meeting in Geneva this week for a critical climate summit as global temperatures reach record highs for the third consecutive month.",
    ...
    },
    {
      ...
      summary: "Several classic Broadway shows are being revived with contemporary interpretations that speak to today's audiences.",
    ...
    },
    {
      ...
      summary: "This year's International Film Festival showcased remarkable works from first-time directors across the globe.",
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {articles.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Check back later for updates in this category.</p>
          </div>
        )}
      </main>
